...
import { 
    Building, MapPin, Save, Star, User, Mail, Lock, 
    Siren, BedDouble, Zap, Navigation, CheckCircle, Phone 
...
const EditHospitalScreen = ({ route, navigation }) => {
    ...
    const [representativeName, setRepresentativeName] = useState(initialHospital.representative_name || '');
    const [email, setEmail] = useState(initialHospital.email || '');
        ...
        >
            <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.header}>
                    ...
                    <Text style={[styles.subtitle, { color: theme.secondaryText }]}>Update facility information and representative details</Text>
                </View>

                <View style={[styles.card, { backgroundColor: theme.card, shadowColor: isDark ? '#000' : '#d1d5db' }]}>
                    <Text style={[styles.sectionTitle, { color: theme.text, fontSize: 16, fontWeight: 'bold', marginBottom: 15 }]}>Representative Account Details</Text>
                    <InputField 
                    ...
                    <Text style={[styles.sectionTitle, { color: theme.text, fontSize: 16, fontWeight: 'bold', marginBottom: 15 }]}>Hospital Information</Text>
                    ...
                    <InputField 
                        label="Rating (0-5)" 
                        icon={Star} 
                        value={hospital.rating?.toString()}
